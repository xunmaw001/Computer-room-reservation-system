				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="jifanghao" id="jifanghao" placeholder="机房号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="shiduan" id="shiduan" placeholder="时段" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">座位号</label>
							<div class="layui-input-block">
								<input type="text" name="zuoweihao" id="zuoweihao" placeholder="座位号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">取消理由</label>
							<div class="layui-input-block">
								<input type="text" name="quxiaoliyou" id="quxiaoliyou" placeholder="取消理由" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
