  ...
  <div id="app">
      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="jifangbianhao" id="jifangbianhao" placeholder="机房编号" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('jifanghao','新增')" @click="jump('../jifanghao/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <a :href="'../jifanghao/detail.jsp?id='+item.id">查看详情</a>
        </div>
      </div>
      <div class="clear"></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jifangbianhao').val()) {
          param['jifangbianhao'] = jquery('#jifangbianhao').val() ? '%' + jquery('#jifangbianhao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jifanghao/list', 'get', param, function(res) {
