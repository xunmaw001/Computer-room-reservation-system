		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="jifanghao" id="jifanghao" lay-filter="jifanghao">
                        ...
                        <div class="layui-input-block">
                            <select name="riqi" id="riqi" lay-filter="riqi">
                                <option value="">请选择</option>
                        ...
                        <div class="layui-input-block">
                            <select name="shiduan" id="shiduan" lay-filter="shiduan">
                                <option value="">请选择</option>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('jifangxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
