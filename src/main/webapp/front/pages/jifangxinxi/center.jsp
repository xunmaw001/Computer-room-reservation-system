						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="bianhao" id="bianhao" placeholder="编号" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">机房号</label>
							<div class="layui-input-block">
								<select name="jifanghao" id="jifanghao">
									<option value="">请选择</option>
									<option v-for="(item,index) in jifanghao" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="riqi" id="riqi">
									<option value="">请选择</option>
									<option v-for="(item,index) in riqi" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="shiduan" id="shiduan">
									<option value="">请选择</option>
									<option v-for="(item,index) in shiduan" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">空闲座位</label>
							<div class="layui-input-block">
								<input type="text" name="kongxianzuowei" id="kongxianzuowei" placeholder="空闲座位" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/jifanghao/jifangbianhao`,'get',{},(res)=>{
					vue.jifanghao = res.data
				});
																// 上传图片
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																vue.riqi = '周一,周二,周三,周四,周五'.split(',')
																vue.shiduan = '上午,下午'.split(',')
																																vue.zhuangtai = '未满,已满'.split(',')
