    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('jifangxinxi','新增')" @click="jump('../jifangxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jifanghao').val()) {
          param['jifanghao'] = jquery('#jifanghao').val() ? '%' + jquery('#jifanghao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jifangxinxi/list', 'get', param, function(res) {
