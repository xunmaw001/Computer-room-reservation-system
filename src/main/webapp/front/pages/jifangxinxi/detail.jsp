				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('jifangxinxi','申请预约')" @click="onAcrossTap('shenqingyuyue')" type="button" class="layui-btn">
								申请预约
							</button>
																					<button v-if="isAuth('jifangxinxi','取消预约')" @click="onAcrossTap('quxiaoyuyue')" type="button" class="layui-btn">
								取消预约
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`jifangxinxi`);
