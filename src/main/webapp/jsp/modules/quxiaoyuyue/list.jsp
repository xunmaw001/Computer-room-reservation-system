...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var quxiaoliyouCell  = document.createElement('td');

						  if(item.quxiaoliyou != null && item.quxiaoliyou != "" && item.quxiaoliyou.length >= 11){
			  	quxiaoliyouCell.innerHTML = item.quxiaoliyou.substring(0, 10) + "..."; 
			  }else{
			  	quxiaoliyouCell.innerHTML = item.quxiaoliyou;
			  }


			row.appendChild(quxiaoliyouCell);
